...
describe("WalletAddress", () => {
    ...
    beforeEach(() => {
        ...
        coinbase_1.Coinbase.apiClients.externalAddress.requestExternalFaucetFunds = (0, utils_1.mockFn)(() => {
    ...
    it("should request funds from the faucet and returns the faucet transaction", async () => {
        ...
        expect(coinbase_1.Coinbase.apiClients.externalAddress.requestExternalFaucetFunds).toHaveBeenCalledWith(address.getNetworkId(), address.getId(), undefined);
    ...
    it("should request funds from the faucet and returns the faucet transaction for usdc", async () => {
        ...
        expect(faucetTransaction).toBeInstanceOf(faucet_transaction_1.FaucetTransaction);
        expect(faucetTransaction.getTransactionHash()).toBe(transactionHash);
        expect(coinbase_1.Coinbase.apiClients.externalAddress.requestExternalFaucetFunds).toHaveBeenCalledWith(address.getNetworkId(), address.getId(), "usdc");
        expect(coinbase_1.Coinbase.apiClients.externalAddress.requestExternalFaucetFunds).toHaveBeenCalledTimes(1);
    });
